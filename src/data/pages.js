...
// The key is the item's ID, and the value is its display name.
export const items = {
  dragon_figurine: "Shattered Dragon Figurine",
  closet_key: "Small Iron Key",
  // Add other item IDs and their display names here
};
...
export const pages = [
  ...
  { type: 'link', filename: 'birdroom', title: 'Bird Room', unlocksOnVisit: ['9p'], addsItem: 'dragon_figurine' },
  ...
  { type: 'link', filename: 'pre1', title: 'PrE - 1', counted: false, initialLocked: true, requiresItem: 'dragon_figurine' },
